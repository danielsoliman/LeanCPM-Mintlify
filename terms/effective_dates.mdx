...
iconType: duotone
---
LeanCPM, like legacy CPM, has many date fields for each task, as seen in this guide. The Effective dates are the bottom line; they are the most important dates you share with your subcontractors and clients. 

All other dates are supplemental information for you as a planner.

The Start and Finish, known as the Effective dates, are usually driven by the [target dates](/terms/target_dates).
